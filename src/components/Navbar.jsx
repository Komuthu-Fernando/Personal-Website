...
const Navbar = () => {
	...
	return (
		<nav
			className={`${styles.paddingX} w-full m-2 flex items-center py-3 fixed top-0 z-20 bg-primary rounded-full`}
		>
			<div className="w-full flex justify-between items-center max-w-7x1">
				...
				>
					...
					<p className="text-white text-[18px] font-bold cursor-pointer flex">
						Komuthu &nbsp; <span className="sm:block hidden">| Fernando</span>
					</p>
				</Link>
